...
export function CookieConsentBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-background p-4 shadow-lg md:flex md:items-center md:justify-between md:gap-8">
