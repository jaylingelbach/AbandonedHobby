    ...
    <div className="max-w-3xl mx-auto px-4 py-10 text-sm text-gray-700 leading-relaxed">
      ...
      <Section id="disputes" number={19} title="DISPUTE RESOLUTION">
        <p>
          ...
          excluded from these Legal Terms. In no event shall any claim, action,
          or proceeding brought by either Party related in any way to the
          Services be commenced more than one (1) year after the cause of action
          arose.
        </p>
      </Section>
