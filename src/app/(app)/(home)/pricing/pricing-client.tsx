...
// ——— Neo-brutalist utility styles (with a11y tweaks)
const nbCard = [
    ...
    () => [
      ...
      },
      {
        ...
        answer: (
          <div>
            <p>
              Buyers get their money back; Stripe’s processing fees are
              generally not returned by Stripe. Our marketplace fee is refunded
              proportionally only when you choose to include it in the refund.
            </p>
