        ...
        <div id="invoice-content" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="min-w-0">
              ...
              {order?.buyerEmail && (
                <div
                  className="mt-2 text-sm text-muted-foreground min-w-0 break-word sm:max-w-[260px] md:max-w-none"
            ...
            <div className="min-w-0">
              ...
              <div className="min-w-0 break-word">{sellerName}</div>
              <div
                className="min-w-0 break-word sm:max-w-[260px] md:max-w-none"
                title={sellerEmail}
              >
                {sellerEmail}
              </div>
